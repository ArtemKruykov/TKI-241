    ...
    */
    ...
    public:
        ...
        */
        ...
        /**
        * @brief Чисто виртуальный метод для выполнения задания 1
        */
        virtual void Task1() = 0;

        /**
        * @brief Чисто виртуальный метод для выполнения задания 2
        */
        virtual void Task2() = 0;

        /**
        * @brief Чисто виртуальный метод для выполнения задания 3
        */
